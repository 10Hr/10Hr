...
# <div align="center">👋 Hey welcome to my profile! Im Tyler</div>
...
<tr style="background: rgba(200, 120, 210, 0.1);">
  <td align="center">🎮</td>
...
<details style="background: rgba(125, 207, 255, 0.1); border-radius: 10px; padding: 15px; margin: 10px 0; border-left: 4px solid #7dcfff;">
  ...
  <ul>
    ...
    <li>Developed trading systems, signal generators, and automation tailored to client strategies.
    </li>
    <li>Led a small dev team for product design, client support, and deployment.</li>
    <li>Closed after 5 months to prioritize long term quant career goals.</li>
  </ul>
</details>
...
<details style="background: rgba(157, 214, 180, 0.1); border-radius: 10px; padding: 15px; margin: 10px 0; border-left: 4px solid #9ed6b4;">
  ...
  <ul>
    ...
    <li>Built internal audit/review tools for Sales & Support team call report evaluation.</li>
    <li>Delivered production-ready web tools in a <b>LAMP</b> stack environment.</li>
  </ul>
</details>
...
<details style="background: rgba(244, 176, 132, 0.1); border-radius: 10px; padding: 15px; margin: 10px 0; border-left: 4px solid #f4b084;">
  ...
  <ul>
    ...
    <li>Built a Warehouse Automation System to change scanner paths in the warehouse.</li>
    <li>Created Customer Support tools improving data access for purchase history.</li>
    <li>Worked in an agile team with senior developers on production systems.</li>
  </ul>
</details>
...
<details style="background: rgba(200, 120, 210, 0.1); border-radius: 10px; padding: 15px; margin: 10px 0; border-left: 4px solid #c878d2;">
  ...
  <ul>
    ...
    <li>Led a small team, managing design, art, and project delivery.</li>
    <li>Collaborated with client to align gameplay mechanics with creative goals.</li>
  </ul>
</details>
...
<div style="background: linear-gradient(135deg, #414868 0%, #24283b 100%); color: #a9b1d6; padding: 30px; border-radius: 15px; margin: 20px 0; border: 2px solid #e0af68;">
